    ...
    def _load_distribution_data(self) -> List[Tuple]:
        ...
        return [
           ...
           # 2024 Data (medium confidence – derived)
            ...
            (2024, 157, 158, 4, 4, 1, 'medium', 'derived'),
            (2024, 156, 157, 5, 5, 1, 'medium', 'derived'),
            (2024, 155, 156, 6, 6, 1, 'medium', 'derived'),
            (2024, 154, 155, 8, 8, 1, 'medium', 'derived'),
            (2024, 153, 154, 10, 10, 1, 'medium', 'derived'),
            (2024, 152, 153, 12, 12, 1, 'medium', 'derived'),
            (2024, 151, 152, 15, 15, 1, 'medium', 'derived'),
            (2024, 150, 151, 18, 18, 1, 'medium', 'derived'),
            (2024, 149, 150, 22, 22, 1, 'medium', 'derived'),
            (2024, 148, 149, 27, 27, 1, 'medium', 'derived'),
            (2024, 147, 148, 33, 33, 1, 'medium', 'derived'),
            (2024, 146, 147, 40, 40, 1, 'medium', 'derived'),
            (2024, 145, 146, 48, 48, 1, 'medium', 'derived'),
            (2024, 144, 145, 57, 57, 1, 'medium', 'derived'),
            (2024, 143, 144, 67, 67, 1, 'medium', 'derived'),
            (2024, 142, 143, 78, 78, 1, 'medium', 'derived'),
            (2024, 141, 142, 90, 90, 1, 'medium', 'derived'),
            (2024, 140, 141, 103, 103, 1, 'medium', 'derived'),
            (2024, 139, 140, 117, 117, 1, 'medium', 'derived'),
            (2024, 138, 139, 132, 132, 1, 'medium', 'derived'),
            (2024, 137, 138, 148, 148, 1, 'medium', 'derived'),
            (2024, 136, 137, 165, 165, 1, 'medium', 'derived'),
            (2024, 135, 136, 183, 183, 1, 'medium', 'derived'),
            (2024, 134, 135, 202, 202, 1, 'medium', 'derived'),
            (2024, 133, 134, 222, 222, 1, 'medium', 'derived'),
            (2024, 132, 133, 243, 243, 1, 'medium', 'derived'),
            (2024, 131, 132, 265, 265, 1, 'medium', 'derived'),
            (2024, 130, 131, 288, 288, 1, 'medium', 'derived'),
            (2024, 129, 130, 312, 312, 1, 'medium', 'derived'),
            (2024, 128, 129, 337, 337, 1, 'medium', 'derived'),
            (2024, 127, 128, 363, 363, 1, 'medium', 'derived'),
            (2024, 126, 127, 390, 390, 1, 'medium', 'derived'),
            (2024, 125, 126, 418, 418, 1, 'medium', 'derived'),
            (2024, 124, 125, 447, 447, 1, 'medium', 'derived'),
            (2024, 123, 124, 477, 477, 1, 'medium', 'derived'),
            (2024, 122, 123, 508, 508, 1, 'medium', 'derived'),
            (2024, 121, 122, 540, 540, 1, 'medium', 'derived'),
            (2024, 120, 121, 573, 573, 1, 'medium', 'derived'),
            (2024, 120, 121, 573, 573, 1, 'medium', 'derived'),
            (2024, 119, 120, 607, 607, 1, 'medium', 'derived'),
            (2024, 118, 119, 642, 642, 1, 'medium', 'derived'),
            (2024, 117, 118, 678, 678, 1, 'medium', 'derived'),
            (2024, 116, 117, 715, 715, 1, 'medium', 'derived'),
            (2024, 115, 116, 753, 753, 1, 'medium', 'derived'),
            (2024, 114, 115, 792, 792, 1, 'medium', 'derived'),
            (2024, 113, 114, 832, 832, 1, 'medium', 'derived'),
            (2024, 112, 113, 873, 873, 1, 'medium', 'derived'),
            (2024, 111, 112, 915, 915, 1, 'medium', 'derived'),
            (2024, 110, 111, 958, 958, 1, 'medium', 'derived'),
            (2024, 109, 110, 1002, 1002, 1, 'medium', 'derived'),
            (2024, 108, 109, 1047, 1047, 1, 'medium', 'derived'),
            (2024, 107, 108, 1093, 1093, 1, 'medium', 'derived'),
            (2024, 106, 107, 1140, 1140, 1, 'medium', 'derived'),
            (2024, 105, 106, 1188, 1188, 1, 'medium', 'derived'),
            (2024, 104, 105, 1237, 1237, 1, 'medium', 'derived'),
            (2024, 103, 104, 1287, 1287, 1, 'medium', 'derived'),
            (2024, 102, 103, 1338, 1338, 1, 'medium', 'derived'),
            (2024, 101, 102, 1390, 1390, 1, 'medium', 'derived'),
            (2024, 100, 101, 1443, 1443, 1, 'medium', 'derived'),
            (2024, 72, 73, 6818, 6818, 1, 'medium', 'derived'),  
            (2024, 66, 67, 10365, 10365, 1, 'medium', 'derived'), 
            (2024, 63, 64, 14027, 14027, 1, 'medium', 'derived'),
            (2024, 61, 62, 16759, 16759, 1, 'medium', 'derived'), 
            (2024, 57, 58, 23912, 23912, 1, 'medium', 'derived'), 
            (2024, 46, 47, 84469, 84469, 1, 'medium', 'derived'), 
            (2024, 44, 45, 107623, 107623, 1, 'medium', 'derived'),
            (2024, 41, 42, 152000, 152000, 1, 'medium', 'derived'),
            (2024, 40, 41, 180000, 180000, 1, 'medium', 'derived'),

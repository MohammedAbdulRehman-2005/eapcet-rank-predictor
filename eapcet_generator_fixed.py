    ...
    def _load_distribution_data(self) -> List[Tuple]:
        ...
        return [
           ...
           # 2024 Data (medium confidence – derived)
            (2024, 155, 160, 1, 12, 5, 'medium', 'derived'),
            (2024, 150, 155, 12, 25, 5, 'medium', 'derived'),
            (2024, 145, 150, 25, 40, 5, 'medium', 'derived'),
            (2024, 140, 145, 40, 60, 5, 'medium', 'derived'),
            (2024, 135, 140, 60, 90, 5, 'medium', 'derived'),
            (2024, 130, 135, 90, 130, 5, 'medium', 'derived'),
            (2024, 125, 130, 130, 180, 5, 'medium', 'derived'),
            (2024, 120, 125, 180, 240, 5, 'medium', 'derived'),
            (2024, 115, 120, 240, 330, 5, 'medium', 'derived'),
            (2024, 110, 115, 330, 450, 5, 'medium', 'derived'),
            (2024, 105, 110, 450, 600, 5, 'medium', 'derived'),
            (2024, 100, 105, 600, 800, 5, 'medium', 'derived'),
            (2024, 98, 100, 800, 950, 5, 'medium', 'derived'),
            (2024, 96, 98, 950, 1100, 5, 'medium', 'derived'),
            (2024, 94, 96, 1100, 1300, 5, 'medium', 'derived'),
            (2024, 92, 94, 1300, 1550, 5, 'medium', 'derived'),
            (2024, 90, 92, 1550, 1800, 5, 'medium', 'derived'),
            (2024, 88, 90, 1800, 2100, 5, 'medium', 'derived'),
            (2024, 86, 88, 2100, 2500, 5, 'medium', 'derived'),
            (2024, 84, 86, 2500, 2900, 5, 'medium', 'derived'),
            (2024, 82, 84, 2900, 3400, 5, 'medium', 'derived'),
            (2024, 80, 82, 3400, 4000, 5, 'medium', 'derived'),
            (2024, 75, 80, 4000, 6000, 4, 'medium', 'derived'),
            (2024, 70, 75, 6000, 9300, 4, 'medium', 'derived'),
            (2024, 65, 70, 9300, 15500, 4, 'medium', 'derived'),
            (2024, 60, 65, 15500, 24000, 4, 'medium', 'derived'),
            (2024, 55, 60, 24000, 39000, 4, 'medium', 'derived'),
            (2024, 50, 55, 39000, 71000, 4, 'medium', 'derived'),
            (2024, 45, 50, 71000, 128000, 4, 'medium', 'derived'),
            (2024, 40, 45, 128000, 180424, 3, 'medium', 'derived'),
